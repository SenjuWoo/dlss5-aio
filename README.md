...
<p align="center">
  ...
  <a href="https://github.com/SenjuWoo/dlss5-aio/releases/tag/v1.4.1"><img src="https://img.shields.io/badge/release-v1.4.1-6b8cae?labelColor=0b1016" alt="v1.4.1"></a>
</p>
...
| | |
| --- | --- |
| **Latest release** | [v1.4.1](https://github.com/SenjuWoo/dlss5-aio/releases/tag/v1.4.1) (adds folder 06 — whole-PC DLL refresher) |
...
- latest GitHub release **v1.4.1** (adds folder `06` DLL refresher; DLSS 310.9.1.0, DLSSNR 310.8.SF.0, Swapper 2.2.7)
